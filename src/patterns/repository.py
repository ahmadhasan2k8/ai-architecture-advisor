    ...
    def save(self, user: User) -> User:
        ...
        if user.id is None:
            ...
            cursor.execute(
                ...
                (user.name, user.email, user.created_at.isoformat() if user.created_at else None)
            )
            ...
            cursor.execute(
                ...
                (user.name, user.email, user.created_at.isoformat() if user.created_at else None, user.id)
            )
