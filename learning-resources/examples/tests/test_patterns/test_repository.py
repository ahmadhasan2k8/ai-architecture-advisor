...
class TestDomainModels:
    ...
    def test_user_creation_with_datetime(self):
        ...
        user = User(
            id=1, name="Alice", email="alice@example.com", created_at=created_at
        )
    ...
    def test_product_creation_with_stock_status(self):
        ...
        product = Product(
            id=1, name="Laptop", price=999.99, category="Electronics", in_stock=False
        )
    ...
    def test_order_creation_with_status(self):
        ...
        order = Order(
            id=1, user_id=1, products=[1], total_amount=50.0, status="completed"
        )
    ...
    def test_order_creation_with_datetime(self):
        ...
        created_at = datetime(2023, 1, 1, 12, 0, 0)
        order = Order(
            id=1, user_id=1, products=[1], total_amount=50.0, created_at=created_at
        )
...
class TestInMemoryProductRepository:
    ...
    def test_find_by_category(self):
        ...
        laptop = repo.save(
            Product(id=None, name="Laptop", price=999.99, category="Electronics")
        )
        mouse = repo.save(
            Product(id=None, name="Mouse", price=25.99, category="Electronics")
        )
    ...
    def test_find_by_price_range(self):
        ...
        expensive = repo.save(
            Product(id=None, name="Expensive", price=100.0, category="Test")
        )
    ...
    def test_find_in_stock(self):
        ...
        in_stock = repo.save(
            Product(
                id=None, name="In Stock", price=10.0, category="Test", in_stock=True
            )
        )
        out_of_stock = repo.save(
            Product(
                id=None,
                name="Out of Stock",
                price=10.0,
...
class TestInMemoryOrderRepository:
    ...
    def test_find_by_status(self):
        ...
        pending = repo.save(
            Order(id=None, user_id=1, products=[1], total_amount=50.0, status="pending")
        )
        completed = repo.save(
            Order(
                id=None, user_id=1, products=[2], total_amount=75.0, status="completed"
            )
        )
        cancelled = repo.save(
            Order(
                id=None, user_id=1, products=[3], total_amount=100.0, status="cancelled"
            )
        )
...
class TestSqliteUserRepository:
    ...
    def test_save_and_retrieve_with_datetime(self):
        ...
        created_at = datetime(2023, 1, 1, 12, 0, 0)
        user = User(
            id=None, name="Alice", email="alice@example.com", created_at=created_at
        )
