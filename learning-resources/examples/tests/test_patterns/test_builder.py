...
class TestProductClasses:
    ...
    def test_house_string_representation(self):
        ...
        str_repr = str(house)
        expected = (
            "House: Concrete foundation, Brick walls, Tile roof, 2 floor(s), 3 rooms"
        )
    ...
    def test_pizza_string_minimal(self):
        ...
        pizza = Pizza(
            size="medium", crust="regular", sauce="tomato", cheese="mozzarella"
        )
...
class TestComputerBuilder:
    ...
    def test_multiple_builds(self):
        ...
        computer1 = builder.set_cpu("Intel i5").set_memory("8GB").build()

        # Build second computer (should be different)
        computer2 = builder.reset().set_cpu("Intel i7").set_memory("16GB").build()
...
class TestSQLQueryBuilder:
    ...
    def test_where_multiple_conditions(self):
        ...
        query = builder.where("active = 1").where("age > 18").build()
    ...
    def test_multiple_builds(self):
        ...
        query2 = builder.reset().select("id", "email").from_table("customers").build()
...
class TestBuilderPatternIntegration:
    ...
    def test_pizza_ordering_system(self):
        ...
        assert all(
            p.size in ["small", "medium", "large", "extra-large"] for p in all_pizzas
        )
    ...
    def test_builder_reusability(self):
        ...
        queries = []
        for i in range(3):
            query = sql_builder.reset().select("*").from_table(f"table_{i}").build()
...
class TestBuilderPatternEdgeCases:
    ...
    def test_sql_query_without_from_clause(self):
        ...
        query = builder.select("1", "2", "3").build()
    ...
    def test_builder_with_none_values(self):
        ...
        computer = builder.set_cpu(None).set_memory(None).build()
    ...
    def test_builder_with_empty_strings(self):
        ...
        computer = builder.set_cpu("").set_memory("").build()
    ...
    def test_pizza_with_empty_toppings_list(self):
        ...
        pizza = builder.add_toppings([]).build()
    ...
    def test_house_with_negative_values(self):
        ...
        house = builder.set_windows(-5).set_doors(-2).set_floors(-1).build()
    ...
    def test_sql_builder_with_empty_conditions(self):
        ...
        query = builder.where("").having("").build()
