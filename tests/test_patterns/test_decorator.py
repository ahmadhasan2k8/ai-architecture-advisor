...
class TestBasicDecoratorPattern:
    ...
    def test_multiple_decorators(self):
        ...
        assert decorator_b.operation() == "ConcreteDecoratorB(ConcreteDecoratorA(ConcreteComponent))"
    ...
    def test_decorator_composition(self):
        ...
        assert composition1.operation() == "ConcreteDecoratorB(ConcreteDecoratorA(ConcreteComponent))"
        
        # B then A
        composition2 = ConcreteDecoratorA(ConcreteDecoratorB(component))
        assert composition2.operation() == "ConcreteDecoratorA(ConcreteDecoratorB(ConcreteComponent))"
...
class TestBeverageDecorator:
    ...
    def test_multiple_condiments(self):
        ...
        assert enhanced_coffee.description() == "Simple coffee, milk, sugar, cinnamon, vanilla"
    ...
    def test_complex_beverage_composition(self):
        ...
        coffee = Coffee()
        complex_beverage = WhipCream(Vanilla(Cinnamon(Sugar(Sugar(Milk(Milk(coffee)))))))
        
        # Calculate expected cost
        expected_cost = 5.0 + 1.0 + 1.0 + 0.5 + 0.5 + 0.3 + 0.7 + 1.5  # 10.5
        assert complex_beverage.cost() == expected_cost
        
        expected_description = "Simple coffee, milk, milk, sugar, sugar, cinnamon, vanilla, whip cream"
