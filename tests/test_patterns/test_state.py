...
from src.patterns.state import (
    # Abstract classes
    State, Context, VendingMachineState, TrafficLightState, MediaPlayerState, OrderState,
    
    # Vending Machine implementations
    VendingMachine, WaitingState, CoinInsertedState, DispensingState,
    
    # Traffic Light implementations
    TrafficLight, RedState, YellowState, GreenState,
    
    # Media Player implementations
    MediaPlayer, StoppedState, PlayingState, PausedState,
    
    # Order Processing implementations
    Order, PendingState, PaidState, ShippedState, CancelledState,
    
    # Demo functions
    demonstrate_vending_machine, demonstrate_traffic_light, 
    demonstrate_media_player, demonstrate_order_processing
)
...
class TestVendingMachine:
    ...
    def test_coin_inserted_state_select_available_product(self, vending_machine, capsys):
    ...
    def test_coin_inserted_state_select_unavailable_product(self, vending_machine, capsys):
    ...
    def test_coin_inserted_state_select_out_of_stock_product(self, vending_machine, capsys):
