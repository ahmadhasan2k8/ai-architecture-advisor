...
class TestPaymentStrategies:
    ...
    def test_credit_card_invalid_number(self, capsys):
        ...
        payment = CreditCardPayment("123456789012345", "John Doe", "123", "12/25")  # 15 digits
    ...
    def test_credit_card_invalid_cvv(self, capsys):
        ...
        payment = CreditCardPayment("1234567890123456", "John Doe", "12", "12/25")  # 2 digits
    ...
    def test_cryptocurrency_payment_creation(self):
        ...
        payment = CryptocurrencyPayment("1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa", "private_key", "Bitcoin")
    ...
    def test_cryptocurrency_default_currency(self):
        ...
        payment = CryptocurrencyPayment("1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa", "private_key")
